...
#
#
# # Fu nction to display the player's current status
# def display_status():
...
#         self.library.add_door(self.kitchen,)
#         self.library.add_door(self.bedroom,)
#         self.library.add_door(self.library)
#
#
#         self.current_room = self.library
#
...
#             self.oxygen_level -= 5
#             print(f'{self.player_name}, you moved to the {self.current_room.name}.')
#             print(self.current_room.description)
#         else:
#             print(f'Sorry, you cannot move in that direction. Try "move to [room name]".')
#
#     def play(self):
#         print(f'Welcome, {self.player_name}! You start in the library.')
#         print(self.library.description)
#
#         while self.current_room != self.bedroom:
#             print(f'Your oxygen level: {self.oxygen_level}')
...
#                 self.move(room_name)
#
#         print('Congratulations! You have entered the bedroom.')
...
#
#     def __init__(self):
#         self.name = input("What's your name sailor?")
#         # How do we instantiate rooms from JSON?
#         self.room = 1
#         self.oxygen = 100
#
#
